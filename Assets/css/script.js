...
function generateQuestion() {
    ...
    // when the user clicks the start button, the textbox dissappears, and the question-box will appear.

    questions[questionsAnswered].answers.forEach((answer) => {
        if (answer!==undefined) {
            // Access properties of answer here
...
function addPlayerToStorage(player) {
    ...
    // Adds a new player to array
    playersFromStorage.push(player);

    // Converting to JSON string and set it to local storage
